...
import { CreditCard, Calendar, TrendingUp, RefreshCw, Loader2, AlertTriangle, TrendingDown } from 'lucide-react';
    ...
    if (isLoading) {
        return (
            <div className="flex justify-center items-center min-h-screen bg-gray-100">
                ...
                <span className="text-xl text-gray-600">Loading Transaction History...</span>
            </div>
        );
    }
