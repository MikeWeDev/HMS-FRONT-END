...
import { HiOutlineUser, HiOutlineUserGroup, HiOutlineTrash } from 'react-icons/hi';
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
      <main className="flex-1 p-10">
        <h2 className="text-2xl font-bold mb-6">Staff Users</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center hover:scale-105 transform transition-all duration-300">
            <div className="flex items-center gap-2 text-blue-600">
              ...
              <span className="text-3xl font-extrabold">{totalStaff}</span>
            </div>
            <span className="text-gray-600 mt-2 text-lg font-medium">Total Staff</span>
          </div>

          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center hover:scale-105 transform transition-all duration-300">
            <div className="flex items-center gap-2 text-green-600">
              <HiOutlineUser className="w-6 h-6" />
              <span className="text-3xl font-extrabold">{receptionists}</span>
            </div>
            <span className="text-gray-600 mt-2 text-lg font-medium">Receptionists</span>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center hover:scale-105 transform transition-all duration-300">
            ...
            <span className="text-gray-600 mt-2 text-lg font-medium">Admins</span>
          </div>
        </div>
