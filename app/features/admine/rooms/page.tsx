...
export default function AdminRoomsPage() {
  ...
  const bookedRooms = useMemo(() => rooms.filter(r => r.status === "Booked" || r.status === "Checked-In").length, [rooms]);
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans w-[100vw] md:w-full">
     ...
     <header className="bg-white shadow-md p-4 sticky top-0 z-10 border-b border-green-100 w-full">
        <h1 className="text-2xl md:text-3xl font-extrabold text-gray-800 tracking-tight text-center">Room Management</h1>
      </header>
      ...
      <main className="p-4 md:p-8 lg:p-12 max-w-7xl mx-auto w-full">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-6 border-b pb-2">Room Inventory</h2>
